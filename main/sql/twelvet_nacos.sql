...
INSERT INTO `config_info` VALUES (130, 'twelvet-server-job-dev.yml', 'DEFAULT_GROUP', 'server:\r\n    port: 8082\r\n# Spring\r\nspring: \r\n  datasource:\r\n    dynamic:\r\n      # 设置默认的数据源或者数据源组,默认值即为master\r\n      primary: master \r\n      druid:\r\n        initial-size: 5\r\n        min-idle: 5\r\n        maxActive: 20\r\n        maxWait: 60000\r\n        timeBetweenEvictionRunsMillis: 60000\r\n        minEvictableIdleTimeMillis: 300000\r\n        validationQuery: SELECT 1 FROM DUAL\r\n        testWhileIdle: true\r\n        testOnBorrow: false\r\n        testOnReturn: false\r\n        poolPreparedStatements: true\r\n        maxPoolPreparedStatementPerConnectionSize: 20\r\n        filters: stat,wall,slf4j\r\n        connectionProperties: druid.stat.mergeSql\\=true;druid.stat.slowSqlMillis\\=5000\r\n      datasource:\r\n        # 主库数据源\r\n        master:\r\n          driver-class-name: com.mysql.cj.jdbc.Driver\r\n          url: jdbc:mysql://127.0.0.1:3306/twelvet_job?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=GMT%2B8\r\n          username: twelvet\r\n          password: liuxingmin\r\n        # 从库数据源\r\n        # slave:\r\n        # username:\r\n        # password:\r\n        # url:\r\n        # driver-class-name:\r\n      # 开启seata代理，开启后默认每个数据源都代理,分布式事务必须开启,否则关闭\r\n      seata: false\r\nswagger:\r\n  title: TwelveT Swagger API\r\n  version: 1.1.0\r\n  description: 分布式调度服务\r\n  license: Powered By TwelveT\r\n  licenseUrl: https://www.twelvet.cn\r\n  terms-of-service-url: https://www.twelvet.cn\r\n  contact:\r\n    name: TwelveT\r\n    email: 2471835953@qq.com\r\n    url: https://www.twelvet.cn\r\n  authorization:\r\n    name: twelvet\r\n    auth-regex: ^.*$\r\n    authorization-scope-list:\r\n      - scope: server\r\n        description: server all\r\n    token-url-list:\r\n      - http://${GATEWAY_HOST:twelvet-gateway}:${GATEWAY_PORT:88}/auth/oauth/token\r\n# 开启Swagger增强模式\r\nknife4j:\r\n  enable: true', '48ccd4c8b76b947b2a5b17f61a9a5148', '2020-11-03 15:47:23', '2021-04-11 10:40:03', NULL, '127.0.0.1', '', 'eeb43899-8a88-4f5b-b0e0-d7c8fd09b86e', '分布式定时任务配置', 'null', 'null', 'yaml', 'null');
INSERT INTO `config_info` VALUES (155, 'twelvet-server-dfs-dev.yml', 'DEFAULT_GROUP', 'server:\r\n    port: 8083\r\n\r\nspring: \r\n  datasource:\r\n   dynamic:\r\n      # 设置默认的数据源或者数据源组,默认值即为master\r\n      primary: master \r\n      druid:\r\n        initial-size: 5\r\n        min-idle: 5\r\n        maxActive: 20\r\n        maxWait: 60000\r\n        timeBetweenEvictionRunsMillis: 60000\r\n        minEvictableIdleTimeMillis: 300000\r\n        validationQuery: SELECT 1 FROM DUAL\r\n        testWhileIdle: true\r\n        testOnBorrow: false\r\n        testOnReturn: false\r\n        poolPreparedStatements: true\r\n        maxPoolPreparedStatementPerConnectionSize: 20\r\n        filters: stat,wall,slf4j\r\n        connectionProperties: druid.stat.mergeSql\\=true;druid.stat.slowSqlMillis\\=5000\r\n      datasource:\r\n        # 主库数据源\r\n        master:\r\n          driver-class-name: com.mysql.cj.jdbc.Driver\r\n          url: jdbc:mysql://127.0.0.1:3306/twelvet?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=GMT%2B8\r\n          username: root\r\n          password: 123456\r\n        # 从库数据源\r\n        # slave:\r\n        # username:\r\n        # password:\r\n        # url:\r\n        # driver-class-name:\r\n      # 开启seata代理，开启后默认每个数据源都代理,分布式事务必须开启,否则关闭\r\n      seata: false\r\n\r\n# FastDFS配置\r\nfdfs:\r\n  domain: http://cloud.twelvet.cn\r\n  soTimeout: 3000\r\n  connectTimeout: 2000\r\n  trackerList: 127.0.0.1:22122\r\n\r\nswagger:\r\n  title: TwelveT Swagger API\r\n  version: 1.1.0\r\n  description: DFS服务\r\n  license: Powered By TwelveT\r\n  licenseUrl: https://www.twelvet.cn\r\n  terms-of-service-url: https://www.twelvet.cn\r\n  contact:\r\n    name: TwelveT\r\n    email: 2471835953@qq.com\r\n    url: https://www.twelvet.cn\r\n  authorization:\r\n    name: password\r\n    token-url-list:\r\n      - http://${GATEWAY_HOST:localhost}:${GATEWAY_PORT:88}/auth/oauth/token\r\n# 开启Swagger增强模式\r\nknife4j:\r\n  enable: true', '9b0f692f544e80153b1fe434e9ff3515', '2020-12-13 18:42:02', '2021-04-11 10:40:24', NULL, '127.0.0.1', '', 'eeb43899-8a88-4f5b-b0e0-d7c8fd09b86e', '分布式文件系统', 'null', 'null', 'yaml', 'null');
...
INSERT INTO `config_info` VALUES (204, 'twelvet-server-gen-dev.yml', 'DEFAULT_GROUP', 'server:\r\n    port: 8084\r\n# spring配置\r\nspring: \r\n  datasource:\r\n    dynamic:\r\n      # 设置默认的数据源或者数据源组,默认值即为master\r\n      primary: master \r\n      druid:\r\n        initial-size: 5\r\n        min-idle: 5\r\n        maxActive: 20\r\n        maxWait: 60000\r\n        timeBetweenEvictionRunsMillis: 60000\r\n        minEvictableIdleTimeMillis: 300000\r\n        validationQuery: SELECT 1 FROM DUAL\r\n        testWhileIdle: true\r\n        testOnBorrow: false\r\n        testOnReturn: false\r\n        poolPreparedStatements: true\r\n        maxPoolPreparedStatementPerConnectionSize: 20\r\n        filters: stat,wall,slf4j\r\n        connectionProperties: druid.stat.mergeSql\\=true;druid.stat.slowSqlMillis\\=5000\r\n      datasource:\r\n        # 主库数据源\r\n        master:\r\n          driver-class-name: com.mysql.cj.jdbc.Driver\r\n          url: jdbc:mysql://rm-twelvet.mysql.rds.aliyuncs.com:3306/twelvet?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=GMT%2B8\r\n          username: twelvet\r\n          password: liuxingmin\r\n        # 从库数据源\r\n        # slave:\r\n        # username:\r\n        # password:\r\n        # url:\r\n        # driver-class-name:\r\n      # 开启seata代理，开启后默认每个数据源都代理,分布式事务必须开启,否则关闭\r\n      seata: false\r\n  redis:\r\n    host: 47.107.77.38\r\n    port: 6379\r\n    password: \r\n    # 连接超时时间\r\n    timeout: 30s\r\n    lettuce:\r\n      pool:\r\n        # 连接池中的最小空闲连接\r\n        min-idle: 0\r\n        # 连接池中的最大空闲连接\r\n        max-idle: 8\r\n        # 连接池的最大数据库连接数\r\n        max-active: 8\r\n        # #连接池最大阻塞等待时间（使用负值表示没有限制）\r\n        max-wait: -1ms\r\n\r\n# 代码生成\r\ngen: \r\n  # 作者\r\n  author: TwelveT\r\n  # 默认生成包路径 system 需改成自己的模块名称 如 system monitor tool\r\n  packageName: com.twelvet.server.system\r\n  # 自动去除表前缀，默认是false\r\n  autoRemovePre: false\r\n  # 表前缀（生成类名不会包含表前缀，多个用逗号分隔）\r\n  tablePrefix: sys_\r\nswagger:\r\n  title: TwelveT Swagger API\r\n  version: 1.1.0\r\n  description: CRUD服务\r\n  license: Powered By TwelveT\r\n  licenseUrl: https://www.twelvet.cn\r\n  terms-of-service-url: https://www.twelvet.cn\r\n  contact:\r\n    name: TwelveT\r\n    email: 2471835953@qq.com\r\n    url: https://www.twelvet.cn\r\n  authorization:\r\n    name: password\r\n    token-url-list:\r\n      - http://${GATEWAY_HOST:localhost}:${GATEWAY_PORT:88}/auth/oauth/token\r\n# 开启Swagger增强模式\r\nknife4j:\r\n  enable: true', 'dc6806ddf7d5d4f46c7a0a1451c64ce8', '2021-03-27 17:08:10', '2021-04-11 10:40:40', NULL, '127.0.0.1', '', 'eeb43899-8a88-4f5b-b0e0-d7c8fd09b86e', '代码生成器', '', '', 'yaml', '');
...
-- ----------------------------
INSERT INTO `his_config_info` VALUES (19, 1, 'twelvet-server-system-dev.yml', 'DEFAULT_GROUP', '', 'server:\r\n  port: 8081\r\n\r\nspring: \r\n  datasource:\r\n    dynamic:\r\n      # 设置默认的数据源或者数据源组,默认值即为master\r\n      primary: master \r\n      druid:\r\n        initial-size: 5\r\n        min-idle: 5\r\n        maxActive: 20\r\n        maxWait: 60000\r\n        timeBetweenEvictionRunsMillis: 60000\r\n        minEvictableIdleTimeMillis: 300000\r\n        validationQuery: SELECT 1 FROM DUAL\r\n        testWhileIdle: true\r\n        testOnBorrow: false\r\n        testOnReturn: false\r\n        poolPreparedStatements: true\r\n        maxPoolPreparedStatementPerConnectionSize: 20\r\n        filters: stat,wall,slf4j\r\n        connectionProperties: druid.stat.mergeSql\\=true;druid.stat.slowSqlMillis\\=5000\r\n      datasource:\r\n        # 主库数据源\r\n        master:\r\n          driver-class-name: com.mysql.cj.jdbc.Driver\r\n          url: jdbc:mysql://127.0.0.1:3306/twelvet?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=GMT%2B8\r\n          username: root\r\n          password: 123456\r\n        # 从库数据源\r\n        # slave:\r\n        # username:\r\n        # password:\r\n        # url:\r\n        # driver-class-name:\r\n      # 开启seata代理，开启后默认每个数据源都代理,分布式事务必须开启,否则关闭\r\n      seata: false\r\n  redis:\r\n    host: 127.0.0.1\r\n    port: 6379\r\n    password: \r\n    # 连接超时时间\r\n    timeout: 30s\r\n    lettuce:\r\n      pool:\r\n        # 连接池中的最小空闲连接\r\n        min-idle: 0\r\n        # 连接池中的最大空闲连接\r\n        max-idle: 8\r\n        # 连接池的最大数据库连接数\r\n        max-active: 8\r\n        # #连接池最大阻塞等待时间（使用负值表示没有限制）\r\n        max-wait: -1ms\r\n', '7a78b8d83f831e1a3c2d722a94a3d6e6', '2010-05-05 00:00:00', '2021-03-20 17:34:57', NULL, '127.0.0.1', 'U', 'eeb43899-8a88-4f5b-b0e0-d7c8fd09b86e');
INSERT INTO `his_config_info` VALUES (155, 2, 'twelvet-server-dfs-dev.yml', 'DEFAULT_GROUP', '', 'server:\r\n    port: 8083\r\n\r\nspring: \r\n  datasource:\r\n   dynamic:\r\n      # 设置默认的数据源或者数据源组,默认值即为master\r\n      primary: master \r\n      druid:\r\n        initial-size: 5\r\n        min-idle: 5\r\n        maxActive: 20\r\n        maxWait: 60000\r\n        timeBetweenEvictionRunsMillis: 60000\r\n        minEvictableIdleTimeMillis: 300000\r\n        validationQuery: SELECT 1 FROM DUAL\r\n        testWhileIdle: true\r\n        testOnBorrow: false\r\n        testOnReturn: false\r\n        poolPreparedStatements: true\r\n        maxPoolPreparedStatementPerConnectionSize: 20\r\n        filters: stat,wall,slf4j\r\n        connectionProperties: druid.stat.mergeSql\\=true;druid.stat.slowSqlMillis\\=5000\r\n      datasource:\r\n        # 主库数据源\r\n        master:\r\n          driver-class-name: com.mysql.cj.jdbc.Driver\r\n          url: jdbc:mysql://127.0.0.1:3306/twelvet?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=GMT%2B8\r\n          username: root\r\n          password: 123456\r\n        # 从库数据源\r\n        # slave:\r\n        # username:\r\n        # password:\r\n        # url:\r\n        # driver-class-name:\r\n      # 开启seata代理，开启后默认每个数据源都代理,分布式事务必须开启,否则关闭\r\n      seata: false\r\n\r\n# FastDFS配置\r\nfdfs:\r\n  domain: http://cloud.twelvet.cn\r\n  soTimeout: 3000\r\n  connectTimeout: 2000\r\n  trackerList: 127.0.0.1:22122\r\n\r\n', 'eb1826623fcc718134f1d8266f425fa9', '2010-05-05 00:00:00', '2021-03-20 17:35:10', NULL, '127.0.0.1', 'U', 'eeb43899-8a88-4f5b-b0e0-d7c8fd09b86e');
INSERT INTO `his_config_info` VALUES (130, 3, 'twelvet-server-job-dev.yml', 'DEFAULT_GROUP', '', 'server:\r\n    port: 8082\r\n# Spring\r\nspring: \r\n  datasource:\r\n    dynamic:\r\n      # 设置默认的数据源或者数据源组,默认值即为master\r\n      primary: master \r\n      druid:\r\n        initial-size: 5\r\n        min-idle: 5\r\n        maxActive: 20\r\n        maxWait: 60000\r\n        timeBetweenEvictionRunsMillis: 60000\r\n        minEvictableIdleTimeMillis: 300000\r\n        validationQuery: SELECT 1 FROM DUAL\r\n        testWhileIdle: true\r\n        testOnBorrow: false\r\n        testOnReturn: false\r\n        poolPreparedStatements: true\r\n        maxPoolPreparedStatementPerConnectionSize: 20\r\n        filters: stat,wall,slf4j\r\n        connectionProperties: druid.stat.mergeSql\\=true;druid.stat.slowSqlMillis\\=5000\r\n      datasource:\r\n        # 主库数据源\r\n        master:\r\n          driver-class-name: com.mysql.cj.jdbc.Driver\r\n          url: jdbc:mysql://127.0.0.1:3306/twelvet_job?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=GMT%2B8\r\n          username: twelvet\r\n          password: liuxingmin\r\n        # 从库数据源\r\n        # slave:\r\n        # username:\r\n        # password:\r\n        # url:\r\n        # driver-class-name:\r\n      # 开启seata代理，开启后默认每个数据源都代理,分布式事务必须开启,否则关闭\r\n      seata: false\r\n  ', 'cfaa8dc854bba68f4b9dcb48e6386e7d', '2010-05-05 00:00:00', '2021-03-20 17:35:16', NULL, '127.0.0.1', 'U', 'eeb43899-8a88-4f5b-b0e0-d7c8fd09b86e');
INSERT INTO `his_config_info` VALUES (41, 4, 'twelvet-gateway-dev.yml', 'DEFAULT_GROUP', '', 'server:\r\n  port: 88\r\n\r\nspring: \r\n  cloud:\r\n    gateway:\r\n      loadbalancer: \r\n        use404: true\r\n      discovery:\r\n        locator:\r\n          # 开启服务名称小写匹配\r\n          lowerCaseServiceId: true\r\n          # 开启动态创建路由（不用每个都写死）\r\n          enabled: true\r\n      # 路由配置\r\n      routes:\r\n        # 认证中心\r\n        - id: twelvet-auth\r\n          uri: lb://twelvet-auth\r\n          predicates:\r\n            - Path=/auth/**\r\n          filters:\r\n            - StripPrefix=1\r\n        # 系统模块\r\n        - id: twelvet-system\r\n          # 匹配后提供服务的路由地址\r\n          uri: lb://twelvet-system\r\n           # 断言，路径匹配的进行路由\r\n          predicates:\r\n            - Path=/system/**\r\n          filters:\r\n            # 转发请求时去除路由前缀（system）\r\n            - StripPrefix=1\r\n            # 请求重写，将内部开放服务重写(重要配置，请勿轻易修改，否则将暴露用户信息API)\r\n            - RewritePath=/user/info(?<segment>/?.*), /from-user-info$\\{segment}\r\n            - RewritePath=/operationLog(?<segment>/?.*), /from-operationLog$\\{segment}\r\n            - RewritePath=/loginInfo(?<segment>/?.*), /from-loginInfo$\\{segment}\r\n        # 定时任务\r\n        - id: twelvet-job\r\n          uri: lb://twelvet-job\r\n          predicates:\r\n            - Path=/job/**\r\n          filters:\r\n            - StripPrefix=1\r\n        # DFS文件系统\r\n        - id: twelvet-dfs\r\n          uri: lb://twelvet-dfs\r\n          predicates:\r\n            - Path=/dfs/**\r\n          filters:\r\n            - StripPrefix=1\r\n            # 请求重写，不允许直接上传文件\r\n            - RewritePath=/upload(?<segment>/?.*), /from-upload$\\{segment}\r\n          ', 'd8089cb266522f85218d34fd2ecbc898', '2010-05-05 00:00:00', '2021-03-21 09:26:15', NULL, '127.0.0.1', 'U', 'eeb43899-8a88-4f5b-b0e0-d7c8fd09b86e');
INSERT INTO `his_config_info` VALUES (41, 5, 'twelvet-gateway-dev.yml', 'DEFAULT_GROUP', '', 'server:\r\n  port: 88\r\n\r\nspring: \r\n  cloud:\r\n    gateway:\r\n      loadbalancer: \r\n        use404: true\r\n      discovery:\r\n        locator:\r\n          # 开启服务名称小写匹配\r\n          lowerCaseServiceId: true\r\n          # 开启动态创建路由（不用每个都写死）\r\n          enabled: true\r\n      # 路由配置\r\n      routes:\r\n        # 认证中心\r\n        - id: twelvet-server-auth\r\n          uri: lb://twelvet-server-auth\r\n          predicates:\r\n            - Path=/auth/**\r\n          filters:\r\n            - StripPrefix=1\r\n        # 系统模块\r\n        - id: twelvet-server-system\r\n          # 匹配后提供服务的路由地址\r\n          uri: lb://twelvet-server-system\r\n           # 断言，路径匹配的进行路由\r\n          predicates:\r\n            - Path=/system/**\r\n          filters:\r\n            # 转发请求时去除路由前缀（system）\r\n            - StripPrefix=1\r\n            # 请求重写，将内部开放服务重写(重要配置，请勿轻易修改，否则将暴露用户信息API)\r\n            - RewritePath=/user/info(?<segment>/?.*), /from-user-info$\\{segment}\r\n            - RewritePath=/operationLog(?<segment>/?.*), /from-operationLog$\\{segment}\r\n            - RewritePath=/loginInfo(?<segment>/?.*), /from-loginInfo$\\{segment}\r\n        # 定时任务\r\n        - id: twelvet-server-job\r\n          uri: lb://twelvet-server-job\r\n          predicates:\r\n            - Path=/job/**\r\n          filters:\r\n            - StripPrefix=1\r\n        # DFS文件系统\r\n        - id: twelvet-server-dfs\r\n          uri: lb://twelvet-server-dfs\r\n          predicates:\r\n            - Path=/dfs/**\r\n          filters:\r\n            - StripPrefix=1\r\n            # 请求重写，不允许直接上传文件\r\n            - RewritePath=/upload(?<segment>/?.*), /from-upload$\\{segment}\r\n          ', '50b54df07c779212bb6e0a1e1c57505d', '2010-05-05 00:00:00', '2021-03-21 09:56:06', NULL, '127.0.0.1', 'U', 'eeb43899-8a88-4f5b-b0e0-d7c8fd09b86e');
INSERT INTO `his_config_info` VALUES (41, 6, 'twelvet-gateway-dev.yml', 'DEFAULT_GROUP', '', 'server:\r\n  port: 88\r\n\r\nspring: \r\n  cloud:\r\n    gateway:\r\n      loadbalancer: \r\n        use404: true\r\n      discovery:\r\n        locator:\r\n          # 开启服务名称小写匹配\r\n          lowerCaseServiceId: true\r\n          # 开启动态创建路由（不用每个都写死）\r\n          enabled: true\r\n      # 路由配置\r\n      routes:\r\n        # 认证中心\r\n        - id: twelvet-server-auth\r\n          uri: lb://twelvet-server-auth\r\n          predicates:\r\n            - Path=/auth/**\r\n          filters:\r\n            - StripPrefix=1\r\n        # 系统模块\r\n        - id: twelvet-server-system\r\n          # 匹配后提供服务的路由地址\r\n          uri: lb://twelvet-server-system\r\n           # 断言，路径匹配的进行路由\r\n          predicates:\r\n            - Path=/system/**\r\n          filters:\r\n            # 转发请求时去除路由前缀（system）\r\n            - StripPrefix=1\r\n            # 请求重写，将内部开放服务重写(重要配置，请勿轻易修改，否则将暴露用户信息API)\r\n            - RewritePath=/user/info(?<segment>/?.*), /from-user-info$\\{segment}\r\n            - RewritePath=/operationLog(?<segment>/?.*), /from-operationLog$\\{segment}\r\n            - RewritePath=/loginInfo(?<segment>/?.*), /from-loginInfo$\\{segment}\r\n        # 定时任务\r\n        - id: twelvet-server-job\r\n          uri: lb://twelvet-server-job\r\n          predicates:\r\n            - Path=/job/**\r\n          filters:\r\n            - StripPrefix=1\r\n        # DFS文件系统\r\n        - id: twelvet-server-dfs\r\n          uri: lb://twelvet-server-dfs\r\n          predicates:\r\n            - Path=/dfs/**\r\n          filters:\r\n            - StripPrefix=1\r\n            # 请求重写，不允许直接上传文件\r\n            - RewritePath=/upload(?<segment>/?.*), /from-upload$\\{segment}\r\n        # 代码生成器\r\n        - id: twelvet-server-gen\r\n          uri: lb://twelvet-server-gen\r\n          predicates:\r\n            - Path=/gen/**\r\n          filters:\r\n            - StripPrefix=1\r\n          ', 'f059dac7477779b1cc23abe8ad5db238', '2010-05-05 00:00:00', '2021-03-21 10:04:55', NULL, '127.0.0.1', 'U', 'eeb43899-8a88-4f5b-b0e0-d7c8fd09b86e');
INSERT INTO `his_config_info` VALUES (0, 7, 'twelvet-server-gen-dev.yml', 'DEFAULT_GROUP', '', 'server:\r\n    port: 8083\r\n# spring配置\r\nspring: \r\n  datasource:\r\n    dynamic:\r\n      # 设置默认的数据源或者数据源组,默认值即为master\r\n      primary: master \r\n      druid:\r\n        initial-size: 5\r\n        min-idle: 5\r\n        maxActive: 20\r\n        maxWait: 60000\r\n        timeBetweenEvictionRunsMillis: 60000\r\n        minEvictableIdleTimeMillis: 300000\r\n        validationQuery: SELECT 1 FROM DUAL\r\n        testWhileIdle: true\r\n        testOnBorrow: false\r\n        testOnReturn: false\r\n        poolPreparedStatements: true\r\n        maxPoolPreparedStatementPerConnectionSize: 20\r\n        filters: stat,wall,slf4j\r\n        connectionProperties: druid.stat.mergeSql\\=true;druid.stat.slowSqlMillis\\=5000\r\n      datasource:\r\n        # 主库数据源\r\n        master:\r\n          driver-class-name: com.mysql.cj.jdbc.Driver\r\n          url: jdbc:mysql://rm-twelvet.mysql.rds.aliyuncs.com:3306/twelvet?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=GMT%2B8\r\n          username: twelvet\r\n          password: liuxingmin\r\n        # 从库数据源\r\n        # slave:\r\n        # username:\r\n        # password:\r\n        # url:\r\n        # driver-class-name:\r\n      # 开启seata代理，开启后默认每个数据源都代理,分布式事务必须开启,否则关闭\r\n      seata: false\r\n  redis:\r\n    host: 47.107.77.38\r\n    port: 6379\r\n    password: \r\n    # 连接超时时间\r\n    timeout: 30s\r\n    lettuce:\r\n      pool:\r\n        # 连接池中的最小空闲连接\r\n        min-idle: 0\r\n        # 连接池中的最大空闲连接\r\n        max-idle: 8\r\n        # 连接池的最大数据库连接数\r\n        max-active: 8\r\n        # #连接池最大阻塞等待时间（使用负值表示没有限制）\r\n        max-wait: -1ms\r\n\r\n# 代码生成\r\ngen: \r\n  # 作者\r\n  author: TwelveT\r\n  # 默认生成包路径 system 需改成自己的模块名称 如 system monitor tool\r\n  packageName: com.twelvet.server.system\r\n  # 自动去除表前缀，默认是false\r\n  autoRemovePre: false\r\n  # 表前缀（生成类名不会包含表前缀，多个用逗号分隔）\r\n  tablePrefix: sys_\r\n', '84dc94ed2f64fb75f68c5ca3049317a1', '2010-05-05 00:00:00', '2021-03-27 17:08:10', NULL, '127.0.0.1', 'I', 'eeb43899-8a88-4f5b-b0e0-d7c8fd09b86e');
